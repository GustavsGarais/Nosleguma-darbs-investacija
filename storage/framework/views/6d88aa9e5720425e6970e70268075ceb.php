...
<div id="<?php echo e($tutorialId); ?>" class="tutorial-overlay" style="display:none; position:fixed; inset:0; z-index:9999; pointer-events:none;">
    ...
    <div class="tutorial-popup" style="position:absolute; background:var(--c-surface); border:3px solid var(--c-primary); border-radius:16px; padding:24px; max-width:420px; box-shadow:0 12px 48px rgba(0,0,0,0.6); z-index:10000; pointer-events:auto;">
        <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:16px;">
            <h3 style="margin:0; font-size:22px; font-weight:700; color:var(--c-primary);"><?php echo e(__('tutorial.title')); ?></h3>
            <button type="button" class="tutorial-close" aria-label="<?php echo e(__('tutorial.close')); ?>" style="background:none; border:none; cursor:pointer; padding:4px 8px; color:var(--c-on-surface-2); font-size:24px; line-height:1; border-radius:4px; transition:background 0.2s;">&times;</button>
        </div>
        ...
        <div style="display:flex; justify-content:space-between; gap:12px; align-items:center;">
            <button type="button" class="tutorial-prev btn btn-outline" style="display:none;"><?php echo e(__('tutorial.prev')); ?></button>
            <div style="flex:1;"></div>
            <button type="button" class="tutorial-next btn btn-primary"><?php echo e(__('tutorial.next')); ?></button>
            <button type="button" class="tutorial-finish btn btn-primary" style="display:none;"><?php echo e(__('tutorial.finish')); ?></button>
        </div>
        <div style="margin-top:16px; text-align:center;">
            <span class="tutorial-step-indicator" style="color:var(--c-on-surface-2); font-size:13px; font-weight:500;"><?php echo e(__('tutorial.step_x_of_y', ['x' => 1, 'y' => 1])); ?></span>
        </div>
    </div>
</div>
...
<script>
(function() {
    const tutorialId = '<?php echo e($tutorialId); ?>';
    const isFirstTime = <?php echo e($isFirstTime ? 'true' : 'false'); ?>;
    const currentPage = '<?php echo e($currentPage ?? 'dashboard'); ?>';
    
    const tutorialSteps = <?php echo json_encode($tutorialSteps, 15, 512) ?>;
    ...
    const stepIndicatorTemplate = <?php echo json_encode(__('tutorial.step_x_of_y', ['x' => ':x', 'y' => ':y'])) ?>;
    ...
    function initTutorial() {
        ...
        function completeTutorial() {
            hideTutorial();
            fetch('<?php echo e(route("tutorial.complete")); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\laragon\www\Nosleguma-darbs-investacija\resources\views/components/tutorial.blade.php ENDPATH**/ ?>