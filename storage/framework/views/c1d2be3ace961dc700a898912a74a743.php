...
<div class="auth-page">
    <section class="auth-card" aria-label="<?php echo e(__('Reset Password')); ?>">
        <h1 style="margin:0 0 6px;"><?php echo e(__('Reset Password')); ?></h1>
        <p style="margin:0 0 16px; color: var(--c-on-surface-2);">
            <?php echo e(__('Choose a new password to secure your account.')); ?>
        ...
        <form method="POST" action="<?php echo e(route('password.store')); ?>" style="display:grid; gap:12px;">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="token" value="<?php echo e($token); ?>">

            <label style="display:grid; gap:6px;">
                <span style="font-weight:700; color: var(--c-on-surface);"><?php echo e(__('Email')); ?></span>
                <input type="email" name="email" value="<?php echo e(old('email', $email ?? '')); ?>" required class="footer-email-input" autocomplete="email" />
            </label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Nosleguma-darbs-investacija\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>