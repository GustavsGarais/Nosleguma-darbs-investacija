@php
    ...
    $tutorialSteps = [
        ...
        'show' => [
            ...
            [
                'target' => '.sim-dash-toolbar-modes',
                'position' => 'bottom',
                'heading' => __('tutorial.show.h2c'),
                'content' => __('tutorial.show.1c'),
            ],
            [
            ...
            [
                'target' => '.sim-controls-flyout--lead',
                'fallbackTarget' => '#sim-terminal-lead-splitter',
                'position' => 'right',
            ...
            [
                'target' => '.sim-dash-rail',
                'position' => 'left',
                'heading' => __('tutorial.show.h15'),
                'content' => __('tutorial.show.14'),
            ],
            [
                'target' => '.sim-dash-terminal__footer .sim-accordion',
                'position' => 'top',
                'heading' => __('tutorial.show.h15b'),
                'content' => __('tutorial.show.14b'),
            ],
            [
                'target' => 'main',
                'position' => 'bottom',
