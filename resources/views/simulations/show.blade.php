...
<section class="sim-run-shell sim-run-shell--terminal" aria-label="{{ __('Simulation details') }}">
    ...
    <div class="sim-dash-body">
        <div class="sim-terminal-lead-pane" id="sim-terminal-lead-pane">
        ...
        <div
            ...
            id="sim-terminal-lead-splitter"
            role="separator"
            aria-orientation="vertical"
            aria-expanded="true"
            aria-controls="sim-terminal-lead-pane"
            aria-label="{{ __('sim.terminal.drag_resize_lead') }}"
            title="{{ __('sim.terminal.drag_resize_lead') }}"
            tabindex="0"
