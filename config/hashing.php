...
return [
    ...
    */
    ...
    'bcrypt' => [
        ...
        // When true, rejects non-bcrypt hashes before password_verify (throws RuntimeException).
        // Set HASH_VERIFY=false in .env if stored passwords use Argon2id or other algorithms.
